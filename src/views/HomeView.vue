...
працює = так
останнє_оновлення словник = ()

тривала дія виконати_метод(назва текст, параметри словник = ()) словник
  ...
  вернути json.parse<словник>(текст(відповідь.дані))
кінець
...
поки працює
  якщо останнє_оновлення["update_id"]
    чекати дані = виконати_метод("getUpdates", (offset=((останнє_оновлення["update_id"] як число) + 1)))
  інакше
  ...
  інакше
    оновлення = дані["result"] як список<словник>
